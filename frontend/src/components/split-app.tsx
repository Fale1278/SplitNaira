...
import { buildCreateSplitXdr, buildDistributeXdr, buildLockProjectXdr, getProjectHistory, getSplit, type ProjectHistoryItem } from "@/lib/api";
                            ...
                            <div className="flex flex-col gap-0.5">
                              <div className="flex items-center justify-between">
                                ...
                                <span className="text-[10px] font-mono text-muted tabular-nums opacity-60">
                                  {new Date(item.ledgerCloseTime).toLocaleTimeString([], { hour: "2-digit", minute: "2-digit" })}
                                </span>
                              </div>
